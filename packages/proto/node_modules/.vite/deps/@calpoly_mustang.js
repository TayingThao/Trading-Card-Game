...
var Service = class {
  ...
  process(message2) {
    ...
    if (!Array.isArray(next)) {
      ...
      later.forEach(
        (promise) => promise.then((message22) => {
          if (message22.length) this.consume(message22);
        })
      );
    }
  }
...
function thenRedirect(redirect2, query) {
...
var StoreProvider = class extends Provider {
  ...
  connectedCallback() {
    const service = new StoreService(
      this.context,
      (msg, model) => this._updateFn(msg, model, this._user)
    );
    service.attach(this);
    this._authObserver.observe(({ user }) => {
...
var s$1 = i$1 ? i$1.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0;
var e = "$lit$";
...
var y2 = (t2) => (i2, ...s2) => ({ _$litType$: t2, strings: i2, values: s2 });
var x = y2(1);
var T = Symbol.for("lit-noChange");
var E = Symbol.for("lit-nothing");
var A = /* @__PURE__ */ new WeakMap();
var C = r$2.createTreeWalker(r$2, 129);
function P(t2, i2) {
...
var _Switch = class _Switch2 extends i {
  constructor(routes, historyContext, authContext = "") {
    super();
    this._cases = [];
    this._fallback = () => x` <h1>Not Found</h1> `;
      ...
      if (m2) {
        ...
        if ("redirect" in m2) {
          ...
          if (typeof redirect2 === "string") {
            ...
            return x` <h1>Redirecting to ${redirect2}…</h1> `;
          }
        }
      }
      return this._fallback({});
    };
    return x` <main>${renderView()}</main> `;
  }
...
var _DropdownElement = class _DropdownElement2 extends HTMLElement {
  constructor() {
    super();
    shadow(this).template(_DropdownElement2.template).styles(_DropdownElement2.styles);
    if (this.shadowRoot) {
